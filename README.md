...
![Aperçu ComfyUI Loader](https://i.postimg.cc/W2rGRxTQ/screen-comfyui-loader.png)
...
### Note importante pour les Formats de Workflow

L'application est conçue pour fonctionner de manière optimale avec les fichiers de workflow JSON sauvegardés directement depuis l'interface ComfyUI via **"Exporter (API)"**
*Pour cela activer le Mode Développeur dans les réglages Comfyui*. Un correctif sera à venir pour accepter les JSON de base.

![image](https://github.com/user-attachments/assets/3a5666d6-4bee-4e5f-85ee-bb7198942219)
